      ...
      <div className="min-h-screen bg-gray-50 py-24 px-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border hover:shadow-md transition">
          ...
          {/* CTA */}
          <div className="text-center bg-white p-10 rounded-3xl shadow-md border">
...
function ValueCard({ icon, title, desc }: any) {
  return (
    <div className="bg-white p-6 rounded-2xl shadow-sm border hover:shadow-md transition text-center">
...
function TeamCard({ name, role }: any) {
  return (
    <div className="bg-white p-6 rounded-2xl shadow-sm border text-center hover:shadow-md transition">
